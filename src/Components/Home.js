...
import image12 from './image2.png'
  ...
  Resources
    ...
    <div className='item2'>
      <p className='fade-in-text'>
        <h1>"Empower Your Brand's Impact with a strategic Social Presence"</h1>
        <h5>In the digital agora, where conversations never sleep, our social management app is your vigilant guardian, ensuring your brand is heard.</h5>
          ...
          <input type="button" value="Start Your Free Trail" className='chap2'/>
          <span style={{ marginRight: '35px' }}></span>
          <input type="button" value="Request Demo" className='chap3'/>
